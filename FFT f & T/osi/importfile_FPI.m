function [Time,Amp] = importfile_FPI(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [TIME,AMP] = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   [TIME,AMP] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [Time,Amp] = importfile('C1data00000.dat',1, 10002);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/02/05 17:18:34
